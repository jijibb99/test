    ...
    def mainprocedure():
        ...
        if 'type' in inputValue:
            ...
            mdrdata = pd.DataFrame([
                {'AGE_YR': 0.0,'SEX': 'F','SMOKE_YN': 'Y','LTCF_YN': 'Y','PRIOR_LOS': 0,'CURR_LOS': 0,'OP_VISIT_1YR': 0,
                 'TRNSF_YN': 'Y','READM_30D_YN': 'Y','ICU_STAY': 'Y','MAL_CANCER_YN': 'Y','HEART_DIAG_YN': 'Y',
                 'LIVER_DIAG_YN': 'Y','PNEU_TBRC_DIAG_YN': 'Y','HAEMATO_DIAG_YN': 'Y','SHOCK_DIAG_YN': 'Y',
                 'KIDNEY_DIAG_YN': 'Y','NEURO_DIAG_YN': 'Y','GASTRO_DIAG_YN': 'Y','DIABET_DIAG_YN': 'Y',
                 'RESPI_DIAG_YN': 'Y','ALCOH_DIAG_YN': 'Y','SELF_IMMUN_DIAG_YN': 'Y','UTI_DIAG_YN': 'Y',
                 'SSTI_DIAG_YN': 'Y','POLYTRAUMA_DIAG_YN': 'Y','HYPRTN_DIAG_YN': 'Y','MULTI_INFTN_DIAG_YN': 'Y',
                 'HYPOALBU_SYMT_YN': 'Y','IV_CATH_ORDR_YN': 'Y','FOLEY_CATH_ORDR_YN': 'Y','ARTER_CATH_ORDR_YN': 'Y',
                 'DRAIN_TUBE_ORDR_YN': 'Y','TRACH_TUBE_ORDR_YN': 'Y','NASO_TUBE_ORDR_YN': 'Y',
                 'VENTIL_TUBE_ORDR_YN': 'Y','DIAL_ORDR_YN': 'Y','SRGY_YN': 'Y','TRACH_SRGY_YN': 'Y',
                 'THORA_LUMBER_YN': 'Y','PIPERA_TAZOBAC_DRUG_YN': 'Y','AMINO_PNCILN_DRUG_YN': 'Y','LINE_DRUG_YN': 'Y',
                 'TIGE_DRUG_YN': 'Y','MTRONIDA_DRUG_YN': 'Y','VANCO_DRUG_YN': 'Y','CEFTR_DRUG_YN': 'Y',
                 'IMIPE_MEROPE_DRUG_YN': 'Y','AMIKA_DRUG_YN': 'Y','CLINDA_DRUG_YN': 'Y','SUCRALF_DRUG_YN': 'Y',
                 'IMMUNO_SPP_DRUG_YN': 'Y','VASOP_DRUG_YN': 'Y','MDR_TYPE_MRSA': 0,'MDR_TYPE_VRE': 0,'MDR_TYPE_MRAB': 0,
                 'MDR_TYPE_MRPA': 0,'MDR_TYPE_CRE' :0 },
                {'AGE_YR': 0.0,'SEX': 'M','SMOKE_YN': 'N','LTCF_YN': 'N','PRIOR_LOS': 0,'CURR_LOS': 0,'OP_VISIT_1YR': 0,
                 'TRNSF_YN': 'N','READM_30D_YN': 'N','ICU_STAY': 'N','MAL_CANCER_YN': 'N','HEART_DIAG_YN': 'N',
                 'LIVER_DIAG_YN': 'N','PNEU_TBRC_DIAG_YN': 'N','HAEMATO_DIAG_YN': 'N','SHOCK_DIAG_YN': 'N',
                 'KIDNEY_DIAG_YN': 'N','NEURO_DIAG_YN': 'N','GASTRO_DIAG_YN': 'N','DIABET_DIAG_YN': 'N',
                 'RESPI_DIAG_YN': 'N','ALCOH_DIAG_YN': 'N','SELF_IMMUN_DIAG_YN': 'N','UTI_DIAG_YN': 'N',
                 'SSTI_DIAG_YN': 'N','POLYTRAUMA_DIAG_YN': 'N','HYPRTN_DIAG_YN': 'N','MULTI_INFTN_DIAG_YN': 'N',
                 'HYPOALBU_SYMT_YN': 'N','IV_CATH_ORDR_YN': 'N','FOLEY_CATH_ORDR_YN': 'N','ARTER_CATH_ORDR_YN': 'N',
                 'DRAIN_TUBE_ORDR_YN': 'N','TRACH_TUBE_ORDR_YN': 'N','NASO_TUBE_ORDR_YN': 'N',
                 'VENTIL_TUBE_ORDR_YN': 'N','DIAL_ORDR_YN': 'N','SRGY_YN': 'N','TRACH_SRGY_YN': 'N',
                 'THORA_LUMBER_YN': 'N','PIPERA_TAZOBAC_DRUG_YN': 'N','AMINO_PNCILN_DRUG_YN': 'N','LINE_DRUG_YN': 'N',
                 'TIGE_DRUG_YN': 'N','MTRONIDA_DRUG_YN': 'N','VANCO_DRUG_YN': 'N','CEFTR_DRUG_YN': 'N',
                 'IMIPE_MEROPE_DRUG_YN': 'N','AMIKA_DRUG_YN': 'N','CLINDA_DRUG_YN': 'N','SUCRALF_DRUG_YN': 'N',
                 'IMMUNO_SPP_DRUG_YN': 'N','VASOP_DRUG_YN': 'N','MDR_TYPE_MRSA': 0,'MDR_TYPE_VRE': 0,'MDR_TYPE_MRAB': 0,
                 'MDR_TYPE_MRPA': 0,'MDR_TYPE_CRE' :0  }
            ])
            ...
            mdd = './' + mdr + "_" + date + '/modelcv/lgb_RUS_'
            #mdd = './modelcv/lgb_RUS_'
            prd = []
            ...
            return jsonify({ 'mdrTypCd':'Error: No MDR type specified.'})
    app.run(port=5000)